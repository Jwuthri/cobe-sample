"""A tiny in-memory product catalog (mock) + a forgiving search."""

from __future__ import annotations

from decimal import Decimal

from agent_openai_sdk_v1.domain.cart import CartItem
...
def search(query: str, limit: int = 5) -> list[Product]:
    ...
    We tokenize both sides and require token equality or a proper-prefix match of
    length >= 3. (A naive substring score let "ca" match "cap", which cascaded into
    spurious results for serviceability questions — hence the stricter rule.)
    """
