"""Pricing tables (mock). Pure-functional, no mutation, no framework."""

from __future__ import annotations

from decimal import Decimal

from agno_agent_v1.domain.cart import CartItem, DeliveryOption
...
def quote_promo(code: str, items: list[CartItem]) -> tuple[Decimal, list[str]]:
    ...
    no current items qualify (e.g. SHOES20 with no shoes in the cart).
    """
