"""FastAPI bridge between the ``agent_v2`` graph and the Next.js debug
console.
...
from agent_v2.config import setup_debug_logging
...
app = FastAPI(title="agent_v2 debug API", version="0.1.0")
