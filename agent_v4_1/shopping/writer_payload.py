...
Ported from agent_v4's ``_build_writer_payload`` / ``_pick_mode`` (which read an
``AgentState``) to take plain ``(messages, step_results, cart)``. The writer
...
from agent_v4_1.shopping.extractors import CHECKOUT
