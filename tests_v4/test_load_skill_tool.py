...
from the model-visible schema and injects the real id at runtime, so the
returned ToolMessage matches the AIMessage's tool_call id.
"""

from __future__ import annotations

from agent_v4.skills import CHECKOUT_SKILLS, make_load_skill_tool
