...
from tests_lg_agent_v2.conftest import call_then_done, say, sequence
...
def test_empty_cart_hides_checkout_tool(make_session):
    ...
    from tests_lg_agent_v2.conftest import ToolCallingFake
...
def test_input_guardrail_blocks_before_any_model_call(make_session):
    from lg_agent_v2.runtime.guardrails import Blocklist

    s = make_session(input_rules=[Blocklist(phrases=["forbidden"], message="I can't help with that.")])
    # no fake models needed: a blocked turn never reaches a model
