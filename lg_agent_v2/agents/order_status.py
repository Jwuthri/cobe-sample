...
from lg_agent_v2.agents.names import ORDER_STATUS
from lg_agent_v2.runtime import ShoppingDeps, StepResult, Worker, build_model, tool_returns
...
def build(model: Any | None = None):
    """Compile the order_status worker (optionally with an injected model, for tests)."""
    return create_agent(
