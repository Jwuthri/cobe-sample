...
from lg_agent_v2.agents import checkout, order_status, product_rec
from lg_agent_v2.agents.names import CHECKOUT, ORDER_STATUS, PRODUCT_REC
...
def build_orchestrator(
    ...
    workers; omitted, each worker uses its module-level default agent.
    """
