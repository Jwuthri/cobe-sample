...
here; the tools are dumb wrappers around these methods.
"""
...
from lg_agent.shopping.domain.catalog import get as get_product
from lg_agent.shopping.domain.pricing import quote_promo, quote_shipping, quote_tax
