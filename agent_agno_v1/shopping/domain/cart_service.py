...
This is the one live object shared across the orchestrator and its member
sub-agents within a turn (carried by reference through Agno ``dependencies``).
"""
...
from agent_agno_v1.shopping.domain.catalog import get as get_product
from agent_agno_v1.shopping.domain.pricing import quote_promo, quote_shipping, quote_tax
