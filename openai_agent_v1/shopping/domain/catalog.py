"""Tiny in-memory product catalog (mock). Self-contained copy."""

from __future__ import annotations

from decimal import Decimal

from openai_agent_v1.shopping.domain.cart import CartItem
...
def search(query: str, limit: int = 5) -> list[Product]:
    ...
    of length >= 3 (substring scoring let "ca" match "cap", which cascaded into
    spurious results for serviceability questions).
    """
