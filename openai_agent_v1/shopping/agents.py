...
The dicts ARE the public surface: an agent's full definition is data. The checkout
config declares the ``cart_anchor`` middleware (the progress block) and NO skills —
the cart drives its flow.
"""

from __future__ import annotations

from openai_agent_v1.core.subagent import SubagentSpec
...
from openai_agent_v1.shopping.prompts import (
    CHECKOUT_PROMPT,
    ORDER_STATUS_PROMPT,
    PRODUCT_REC_PROMPT,
    ROUTER_PROMPT,
...
from openai_agent_v1.shopping.tools import CHECKOUT_TOOLS, ORDER_STATUS_TOOLS, PRODUCT_REC_TOOLS
